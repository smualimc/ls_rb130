...
You should read the text from a simple text file that you provide. (We also supply some example
text below, but try the program with your text as well.)

This question requires that you read a simple text file. Try searching the Web for information 
on how to do this, and also take a look at the File class in the Ruby documentation. If you 
can't figure it out on your own, don't worry: just put the data directly into your program; 
...
The text you use does not have to produce the same numbers as the sample output but should have 
...
# Hint
# You may assume that paragraphs have one empty line between them and that each line ends 
# with a newline character. A single space appears between all words.